...
namespace ECS {
    ...
    public:
        ...
        std::bitset<ECS::MAX_COMPONENTS> component_mask() const;
     ...
     */
    class EntityManager : ECS::help::NonCopyable {
    public:
        ...
        public:
            struct Unpacker {
                ...
                void unpack(ECS::Entity& entity) const {
            ...
            private:
                ...
                void unpack_(ECS::Entity& entity) const {
...
namespace std {
    template <> struct hash<Hildur::ECS::Entity> {
        std::size_t operator () (const Hildur::ECS::Entity& entity) const {
            return static_cast<std::size_t>(entity.id().index() ^ entity.id().version());
        }
    };

    template <> struct hash<const Hildur::ECS::Entity> {
        std::size_t operator () (const Hildur::ECS::Entity& entity) const {
            return static_cast<std::size_t>(entity.id().index() ^ entity.id().version());
        }
    };
