...
namespace Hildur {
	...
	public:
		...
		virtual void SetUniform(const std::string& name, const glm::vec2& values) = 0;
		virtual void SetUniform(const std::string& name, const glm::vec3& values) = 0;
		virtual void SetUniform(const std::string& name, const glm::vec4& values) = 0;
